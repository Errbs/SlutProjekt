...
namespace SlutProjekt
{
    class Macrophage:ImmuneCell
    {
        ...
        {
            List<string> abilityList = new List<string>() { "Phagocytosis" };
            return abilityList;
        }
        public override string Description()
        {
            return "In the big picture of things, macrophages can ingest and destroy bacteria, clean up cellular debris and other harmful particles, as well as dead cells that contain microbes, such as bacteria or viruses." +
